...
public class Mats_Adapter2 extends RecyclerView.Adapter<Mats_Adapter2.ViewHold> {
    private ArrayList<Mats_ModelClass> dataList;
    private final Context context;


    public Mats_Adapter2(Context fragment, ArrayList<Mats_ModelClass> dataList) {
    ...
    public void onBindViewHolder(Mats_Adapter2.ViewHold holder, int position){
        Mats_ModelClass ss=dataList.get(position);
    ...
    public void filterList(ArrayList<Mats_ModelClass> filteredlist) {
